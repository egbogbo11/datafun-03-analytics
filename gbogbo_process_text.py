"""
Process a text file to count occurrences of the word "Drizzy" and save the result.
"""
...
def process_text_file():
    ...
    input_file = pathlib.Path(fetched_folder_name, "drakelyrics.txt")
    output_file = pathlib.Path(processed_folder_name, "text_drizzy_word_count.txt")
    word_to_count: str = "Drizzy"
